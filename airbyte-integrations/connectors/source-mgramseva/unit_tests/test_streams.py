...
import pytest
from source_mgramseva.source import MgramsevaStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(MgramsevaStream, "path", "v0/example_endpoint")
    mocker.patch.object(MgramsevaStream, "primary_key", "test_primary_key")
    mocker.patch.object(MgramsevaStream, "__abstractmethods__", set())
